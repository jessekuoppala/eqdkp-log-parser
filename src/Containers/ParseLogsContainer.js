...
export class ParseLogsContainer extends React.Component {
    ...
    getInitialState = () => {
        const initialState = {
            ...
            zones: [
                {value: "Acrylia Caverns", label: "Acrylia Caverns"},
                {value: "Akheva Ruins", label: "Akheva Ruins"},
                {value: "Dragon Necropolis", label: "Dragon Necropolis"},
                {value: "Dreadlands", label: "Dreadlands"},
                {value: "Griegs End", label: "Griegs End"},
                {value: "Ssraeshza Temple", label: "Ssraeshza Temple"},
                {value: "Emerald Jungle", label: "Emerald Jungle"},
                {value: "Kael Drakkel", label: "Kael Drakkel"},
